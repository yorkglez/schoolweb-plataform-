...
<form>
	...
	<div class="row">
		...
		<div class="col-md-2 mb-3" style="position: relative;">
			<button id="btn-add" type="submit" class="btn btn-success" style="position: absolute; bottom: 0;">Agregar</button>
		</div>
	</div>
	<button id="btn-send" type="submit" class="btn btn-primary">Guardar</button>
