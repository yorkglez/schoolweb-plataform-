...
Route::group(['prefix' => 'admin', 'middleware'=> 'admin'], function() {
	...
	Route::post('updatelist', 'SubjectslistController@updatelist')->name('admin.updatelist');
	...
	Route::resource('subjectslist','SubjectslistController');
	Route::get('subjectslistindex', 'SubjectslistController@index')->name('admin.subjectslist');
